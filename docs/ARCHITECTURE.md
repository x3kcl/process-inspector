...
- **RBAC:** `VIEWER` (read-only) → **`RESPONDER`** (tier-0 verbs + unstick + notes — the
  ...
  leak-views and trends — issue #126 closes out the last two) intersect the caller's grants at
