...
- With `spring.threads.virtual.enabled=true` on Java 21, `synchronized` around any blocking call (JDBC, HTTP) is a defect class until the JDK 24 bump — use `ReentrantLock` instead (issue #306).
